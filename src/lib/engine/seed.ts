...
export function seedHistory(): HistoryRow[] {
  ...
  const m2: [string, number, number, number, number][] = [
    ["Jul 25", 111, 1087, 1133, 4788], ["Aug 25", 122, 1421, 1421, 4910], ["Sep 25", 94, 1022, 1022, 5004],
    ["Oct 25", 104, 1154, 1154, 5108], ["Nov 25", 86, 1010, 1010, 5194], ["Dec 25", 50, 664, 0, 5244],
    ["Jan 26", 71, 1681, 1681, 5315], ["Feb 26", 41, 586, 586, 5356], ["Mar 26", 23, 921, 921, 5379],
    ["Apr 26", 37, 1042, 1042, 5416], ["May 26", 64, 1339, 1339, 5480], ["Jun 26", 165, 3011, 3011, 5645],
    ["Jul 26", 209, 9437, 9437, 5854],
  ];
  return [
