    ...
    <div className="space-y-5">
      ...
      <section className="rounded-2xl bg-elevated p-5 shadow-border sm:p-6">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-border p-4"><p className="font-medium">Readings CSV</p><p className="mt-1 text-sm text-muted">Exchange readings with Excel or Google Sheets. Imports add new rows and skip duplicates.</p><Button className="mt-3" variant="outline" onClick={exportCsv}>Export readings CSV</Button></div>
        </div>
