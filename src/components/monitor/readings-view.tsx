...
type MeterKey = "m1" | "m2";
type ScanState = { value: string; thumb: string | null; original: string | null; status: "idle" | "scanning" | "done" | "error"; result: MeterReadingResult | null; detectedMeter: MeterKey | null; needsChoice: boolean; error: string };
function emptyScan(value = ""): ScanState { return { value, thumb: null, original: null, status: "idle", result: null, detectedMeter: null, needsChoice: false, error: "" }; }
